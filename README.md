...
**🇹🇷 Türkçe**  
2013 yılında yazılıma başladım. İstanbul Medeniyet Üniversitesi Matematik bölümü mezunuyum. Matematiksel düşünce altyapımı Python ile veri analitiği, makine öğrenmesi, yerel ağ araçları ve işletmeler için pratik masaüstü/donanım yazılımları geliştirmede kullanıyorum.

**🇺🇸 English**  
I have been coding since 2013 and graduated with a degree in Mathematics from Istanbul Medeniyet University. I combine my mathematical foundation with Python to build data analytics systems, machine learning models, networking tools, and practical desktop/hardware applications.
